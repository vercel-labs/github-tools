...
const layers = [
  {
    title: 'Tools',
    description: '53 AI-callable GitHub operations — repositories, branches, pull requests, issues, commits, releases, checks, search, gists, and workflows.',
...
<span class="text-highlighted">export default</span> githubExtension({
  preset: 'maintainer',
            ...
            <p class="text-sm/6 text-toned">
              ...
              With the eve extension, one file registers all 53 tools — durable approval included.
            </p>
          </NuxtLink>
        </div>
