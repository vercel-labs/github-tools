...
This is the headline improvement over the AI SDK boolean `requireApproval` and over [durable Workflow agents](/guide/durable-workflows), where approval is ignored today.
