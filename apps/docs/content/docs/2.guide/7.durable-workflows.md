...
::note
For a complete working example that connects a durable agent to GitHub via [Chat SDK](https://chat-sdk.dev), see the [`examples/github-bot/`](https://github.com/vercel-labs/github-tools/tree/main/examples/github-bot) starter — a ~80-line PR review bot with multi-turn durable sessions and [evlog](https://evlog.dev) AI observability.
::
