...
The SDK reads `GITHUB_TOKEN` from your environment automatically. This gives the model access to all 39 tools — see the [Tools Catalog](/api/tools-catalog) for what each one does.
