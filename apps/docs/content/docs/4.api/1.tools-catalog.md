...
| `getRepositoryTree` | list the file and directory structure of a repository at a given ref | — |
...
| Tool | Capability | Write |
|---|---|---|
| `listReleases` | list releases for a repository, newest first (includes drafts and prereleases) | — |
