...
Read the full walkthrough in [Durable workflows (Vercel Workflow)](/guide/durable-workflows), or see the [`examples/github-bot/`](https://github.com/vercel-labs/github-tools/tree/main/examples/github-bot) starter for a complete PR review bot connected to GitHub via [Chat SDK](https://chat-sdk.dev).
