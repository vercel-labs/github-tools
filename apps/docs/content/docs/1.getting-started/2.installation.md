...
| [eve extension](/frameworks/eve-extension) | `@github-tools/eve-extension` | `eve` (declared `*`, built against 0.63, **`ai` v7** transitively) |
...
See [eve (direct import)](/deprecated/eve) for the deprecated instructions.
