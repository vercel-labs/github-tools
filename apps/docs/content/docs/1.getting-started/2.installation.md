...
For [eve](https://eve.dev) filesystem-first agents, add `eve` and **`ai` v7** when you import from `@github-tools/sdk/eve`:
...
See [eve agents](/guide/eve-agents) for the full pattern.
