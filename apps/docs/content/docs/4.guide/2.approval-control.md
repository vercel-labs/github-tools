...
createGithubAgent({
  ...
  requireApproval: 'auto',
  evaluation: {
    maxRisk: 0.5, // 0 negligible, 1 visible but reversible, 2 hard to undo
    minIntent: 0.8, // probability the user asked for this exact call
    model: 'typesafe-ai/jev-latest', // any AI SDK evaluation model
  },
})
```
