...
| Preset | Repository access | Contents | Pull requests | Issues | Discussions | Actions | Checks/Statuses | Administration |
|---|---|---|---|---|---|---|---|---|
| `repo-explorer` | selected repos | `read` | `read` | `read` | `read` | `read` | `read` | none |
| `code-review` | selected repos | `read` | `read` (or `write` for comments/reviewer requests) | none | none | none | `read` | none |
| `issue-triage` | selected repos | `read` | none | `write` | none | none | none | none |
