...
::prompt
---
description: Configure commit attribution for bot commits
...
| Bot acting on behalf of user | Human (override) | Bot (override)  | N/A       |
| Fully automated CI           | Bot (default)    | Bot (default)   | N/A       |
