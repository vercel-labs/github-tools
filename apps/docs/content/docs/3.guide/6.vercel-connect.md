...
**Deprecated.** This pattern uses the deprecated [direct `@github-tools/sdk/eve` import](/frameworks/eve). Prefer the [eve extension](#eve-extension) above for new agents.
::
...
- [`connectGithubTools` (eve, deprecated)](/api/reference#connectgithubtools--eve) — eve `defineDynamic` sentinel for the direct import
