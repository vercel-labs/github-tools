...
|---|---|---|---|---|---|---|---|
| `repo-explorer` | selected repos | `read` | `read` | `read` | `read` | `read` | — |
| `code-review` | selected repos | `read` | `read` (or `write` for comments/reviewer requests) | — | — | `read` | — |
| `issue-triage` | selected repos | `read` | — | `write` | — | — | — |
| `ci-ops` | selected repos | `read` | — | — | `write` | `read` | — |
| `security-audit` | selected repos | `read` | `read` | `write` (to report findings) | `read` | `read` | — |
| `release-manager` | selected repos | `write` (for release creation) | `read` | — | `write` (if triggering pipelines) | — | — |
...
(For the deprecated direct import, [`connectGithubTools` from `@github-tools/sdk/connect/eve`](/frameworks/eve#vercel-connect) still works the same way.)
::
