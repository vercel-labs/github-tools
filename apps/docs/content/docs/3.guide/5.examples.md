...
The same 53 tools, four runtimes. Each example below is complete and runnable.

### eve extension — a GitHub agent in 3 files

The fastest path to a standalone agent. All 53 tools, durable approval on every write, zero boilerplate ([full guide](/frameworks/eve-extension), [`examples/eve-extension-agent/`](https://github.com/vercel-labs/github-tools/tree/main/examples/eve-extension-agent)):
...
The lower-level [direct `@github-tools/sdk/eve` import](/frameworks/eve) (`examples/eve-agent/`) still works but is deprecated in favor of the extension above.
