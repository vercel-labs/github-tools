...
The fastest path to a standalone agent. All 42 tools, durable approval on every write, zero boilerplate ([full guide](/frameworks/eve-extension), [`examples/eve-extension-agent/`](https://github.com/vercel-labs/github-tools/tree/main/examples/eve-extension-agent)):
