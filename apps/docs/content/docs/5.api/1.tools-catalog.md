...
Notifications belong to a user, not a repository. They need a PAT with the **Notifications** account permission and do not work with a Vercel Connect installation token — see [Tokens and Authentication](/guide/tokens-and-auth).
