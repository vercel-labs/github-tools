...
export const GITHUB_TOOL_META: Record<GithubToolName, GithubToolMeta> = {
  ...
  getCommitComment: { title: 'Get Commit Comment', label: 'Comment fetched', labelActive: 'Fetching commit comment', icon: 'i-lucide-message-square' },
  listCommitComments: { title: 'List Commit Comments', label: 'Comments listed', labelActive: 'Listing commit comments', icon: 'i-lucide-message-square' },
  createCommitComment: { title: 'Comment on Commit', label: 'Comment posted', labelActive: 'Posting commit comment', icon: 'i-lucide-message-square-plus' },
  updateCommitComment: { title: 'Update Commit Comment', label: 'Comment updated', labelActive: 'Updating commit comment', icon: 'i-lucide-message-square-text' },
  deleteCommitComment: { title: 'Delete Commit Comment', label: 'Comment deleted', labelActive: 'Deleting commit comment', icon: 'i-lucide-message-square-x' },
