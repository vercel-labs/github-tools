...
export function createToolRegistry(ctx: ToolBuildContext): ToolRegistryEntry[] {
  return [
    ...
    },
    {
      ...
      description: commits.getCommitCommentDescription,
      inputSchema: commits.getCommitCommentInputSchema,
      execute: withToken(commits.getCommitCommentCore, ctx),
    },
    {
      name: 'listCommitComments',
      description: commits.listCommitCommentsDescription,
      inputSchema: commits.listCommitCommentsInputSchema,
      execute: withToken(commits.listCommitCommentsCore, ctx),
    },
    {
      name: 'createCommitComment',
      writeTool: 'createCommitComment',
      description: commits.createCommitCommentDescription,
      inputSchema: commits.createCommitCommentInputSchema,
      execute: withToken(commits.createCommitCommentCore, ctx),
    },
    {
      name: 'updateCommitComment',
      writeTool: 'updateCommitComment',
      description: commits.updateCommitCommentDescription,
      inputSchema: commits.updateCommitCommentInputSchema,
      execute: withToken(commits.updateCommitCommentCore, ctx),
    },
    {
      name: 'deleteCommitComment',
      writeTool: 'deleteCommitComment',
      description: commits.deleteCommitCommentDescription,
      inputSchema: commits.deleteCommitCommentInputSchema,
      execute: withToken(commits.deleteCommitCommentCore, ctx),
    },
    {
      name: 'listGists',
