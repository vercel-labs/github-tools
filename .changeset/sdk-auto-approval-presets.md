...
- The new optional `evaluation` option (`{ model, maxRisk, minIntent, minPresetProbability, maxPresets }`) tunes both modes. The model defaults to TypeSafe's Jev (`'typesafe-ai/jev-latest'` through AI Gateway).
