 ...
 * `@github-tools/sdk` tags sweeps up every chat / docs / eve-extension PR that
 * landed in between, so each package's notes list everybody's work.
 *
 ...
 * ## Usage
 *
 *     node scripts/release-notes.mjs '[{"name":"@github-tools/sdk","version":"1.4.0"}]'
 *
...
async function main() {
  ...
  if (!raw) throw new Error('usage: release-notes.mjs \'[{"name":"@github-tools/sdk","version":"1.0.0"}]\'')
